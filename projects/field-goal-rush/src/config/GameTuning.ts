...
export const DESIGN_HEIGHT = 1688;
...
export const TUNING = {
  ...
  goalWidth: 240,
  flightDuration: 560,
  kickWindupDuration: 60,
  kickSwingDuration: 75,
  kickFollowThroughDuration: 80,
  kickRetractDuration: 140,
  footSize: 600,
  footFadeStart: .06,
  footFadeEnd: .34,
  arcHeight: 296,
...
export const ASSETS = {
  ...
  kickingFoot: './assets/kicking-foot-v3.png',
